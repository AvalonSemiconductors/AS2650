...
public class PlacementPreview {
	...
	public static void main(String[] args) {
		...
		Macro[] macros = new Macro[] {
			new Macro(400, 1300, 1000, 700, Color.GREEN, "AS2650"), //wrapped_as2650
			new Macro(300, 2400, 300, 352, new Color(240, 128, 32), "Avali Logo"), //avali_logo
			new Macro(2400, 1000, 250, 250, Color.RED, "GPIOs"), //gpios
			...
			new Macro(300, 200, 750, 750, new Color(245/*244*/, 130, 133), "SID"), //sid_top
		};
